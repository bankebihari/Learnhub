  ...
  return (
    <Layout hideFooter={true} hideNav={true} hideBar={true}>
      <section className="flex flex-col gap-6 items-center md:py-8 py-0 px-0 h-screen overflow-y-scroll">
        <div className="flex flex-col dark:bg-base-100 relative md:gap-12 gap-5 rounded-lg md:py-10 md:pt-3 py-0 pt-3 md:px-7 px-0 md:w-[780px] lg:w-[90%] w-full h-full overflow-y-hidden shadow-custom dark:shadow-xl">
          ...
          <div className="flex md:flex-row flex-col md:justify-between w-full h-full">
            <div className="md:w-[68%] w-full md:p-3 p-1 overflow-y-scroll md:h-full h-[40%] flex justify-center">
              <div className="w-full h-auto border bg-[#0000003d] shadow-lg">
                ...
                {lectures && lectures?.[currentVideo]?.isLiveClass && (
                  <div className="live flex items-center justify-center h-[300px]">
                    <button
            ...
            <div className="md:w-[28%] pb-12 md:flex-row flex-col w-full md:h-full h-[60%] overflow-y-scroll">
